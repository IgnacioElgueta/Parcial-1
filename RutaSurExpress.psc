Proceso RutasurExpress
	...
	Definir Precioasiento Como Real;
	...
	Repetir
		...
		Si opcion <> 1 Entonces
			Escribir "Debe presionar (1) para continuar" ;
		FinSi
	...
	Total <- Precio + Solucion + Descuento;
	Escribir "Precio Base: $", Precio;
	Escribir "Cargo adicional asiento: $", Solucion;
	Escribir "Descuento estudiante: $", Descuento;
